    ...
    pages: [
      {
        ...
        href: "/que-es-la-logica",
      },
      {
        title: "¿Qué es un problema?",
        href: "/que-es-un-problema",
      },
      {
    ...
    pages: [
      {
        ...
        href: "/que-es-un-algoritmo",
      },
      {
        title: "Características de un algoritmos",
        href: "/caracteristicas-de-un-algoritmos",
      },
      {
        title: "Partes de un algoritmo",
        href: "/partes-de-un-algoritmo",
      },
      {
        title: "Etapas para la creación de un algoritmo",
        href: "/etapas-para-la-creacion-de-un-algoritmo",
      },
      {
