          ...
          <>
            <section>
              ...
              <p className="">
                ...
                <strong>fácil</strong> y <strong>obvia</strong> de hacer
                cualquier cosa. La lógica se aplica en la resolución de
                problemas a través de la identificación de problemas, la
                formulación de hipótesis y soluciones, la evaluación de
                alternativas y la toma de decisiones basadas en la información
                disponible.
              </p>
            ...
            <section className="mt-12">
              ...
              <p>
                ...
                ordenada. Una definición más orientada a campo de la informática
                es:
              </p>
              ...
              >
                La lógica de programación consiste en la organización y
                planificación coherente de las instrucciones necesarias para
                ejecutar con éxito un programa.
              </Blockquote>

              <p>
                Piensa en cómo se resuelve un problema en la vida real. Si
                tienes que ir a comprar algo, primero piensas en qué necesitas,
                luego decides a dónde ir, cómo llegar allí, qué comprar, cómo
                pagar, etc. Todo esto es parte de la lógica de resolución de
                problemas. En programación, es lo mismo, pero con instrucciones
                que una computadora puede entender y ejecutar.
              </p>

              <p className="pt-8">
                Para contextualizar un poco con un problema cotidiano, tomemos
                el ejemplo de una receta de cocina. Una receta de cocina es un
                conjunto de instrucciones que debes seguir para preparar un
                plato. Si sigues las instrucciones paso a paso, obtendrás el
                plato deseado. ¿Qué tal un paso a paso de cómo preparar un
                sencillo sándwich de jamón y queso? Vamos a ello:
              </p>
              ...
              <p className="pt-8">
                Si bien la preparación de un sándwich es un ejemplo simple, la
                lógica detrás de la receta es la misma que se aplica en la
                programación. ¿Qué pasa si por error colocas el jamón y el queso
                al revés? ¿O si olvidas un ingrediente? ¿O si no sigues los
                pasos en el orden correcto? Todo esto afectará el resultado
                final. El nivel de detalle y complejidad de las instrucciones
                dependerá del problema a resolver y de la solución propuesta.
              </p>

              <p className="pt-6">
                La lógica de programación es fundamental para cualquier persona
                y no solo para programadores. La lógica de programación te ayuda
                a pensar de forma estructurada, a descomponer problemas
                complejos en partes más pequeñas y manejables, y a desarrollar
                soluciones efectivas y eficientes. Repasa y apóyate del
                siguiente video de{" "}
                <a
      ...
      },
      {
        ...
        content: (
          <>
            <section>
              <p>
                Ya que sabes que es la lógica y cómo se aplica, es hora de usarla para resolver problemas.
                Pero, ¿qué es un problema? ¿Cómo se define un problema?
              ...
              <p className="">
                Un problema es un enunciado en el cual se da cierta <strong>información</strong> y se plantea una
                <strong> pregunta</strong> que debe ser respondida; en general se pide calcular o indagar uno o
                más <strong>datos</strong> faltantes o generar explicaciones acerca de ciertos hechos o situaciones.
              </p>
              ...
              <Question
                ...
                options={["Una situación que no tiene solución.", "Una cuestión que no tiene una respuesta única.","Una situación o cuestión que requiere una solución o respuesta.","Una tarea que solo puede ser resuelta mediante la intuición."]}
